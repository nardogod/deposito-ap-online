...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'full_name', 'status', 'payment_status', 'delivery_type', 'delivery_date', 'total_amount', 'created_at')
    list_filter = ('status', 'payment_status', 'delivery_type', 'delivery_date')
    ...
    fieldsets = (
        ...
        ('Informações do cliente', {
            'fields': ('full_name', 'email', 'phone', 'address', 'apartment', 'building',
                      'shipping_city', 'shipping_state', 'shipping_postal_code', 'shipping_country', 'shipping_full_name')
        }),
