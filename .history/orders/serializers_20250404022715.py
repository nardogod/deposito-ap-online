...
# Atualize a classe OrderSerializer para incluir os novos campos
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'shipping_full_name', 'total_amount', 'discount_amount', 'coupon_code', 'total', 'status', 'status_display', 
            'payment_status', 'payment_status_display', 'delivery_type', 'delivery_type_display',
            'delivery_date', 'delivery_time_slot', 'notes', 'items', 'created_at', 'updated_at',
            'payment_id', 'payment_method', 'tracking_number', 'estimated_delivery', 
            'cancellation_reason', 'preference_id'
        ]
        read_only_fields = ['user', 'created_at', 'updated_at', 'payment_id', 'payment_method', 
                           ...
                           'preference_id', 'discount_amount', 'coupon_code']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'full_name', 'email', 'phone', 'address', 'apartment', 'building',
            'shipping_city', 'shipping_state', 'shipping_postal_code', 'shipping_country',
            'shipping_full_name', 'total_amount', 'total', 'status', 'status_display', 
            'payment_status', 'payment_status_display', 'delivery_type', 'delivery_type_display',
            'delivery_date', 'delivery_time_slot', 'notes', 'items', 'created_at', 'updated_at',
            'payment_id', 'payment_method', 'tracking_number', 'estimated_delivery', 
            'cancellation_reason', 'preference_id'
