...
class OrderItem(models.Model):
    ...
    product_name = models.CharField(max_length=255, default="Produto")  # Adicionado default
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)  # Adicionado default
...
class CartItem(models.Model):
    ...
    quantity = models.PositiveIntegerField(default=1)
    added_at = models.DateTimeField(default=timezone.now)  # Usando default em vez de auto_now_add
    ...
    # orders/models.py
# Adicione estes campos ao modelo Order existente

# No modelo Order, adicione os seguintes campos
...
# Atualize a propriedade total para considerar o desconto
@property
def total(self):
